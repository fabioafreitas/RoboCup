...
public class MoveAccordingToBall extends BTNode<BehaviorTreePlayer> {
	...
	private boolean posGoleiro(BehaviorTreePlayer agent, Vector2D ballPos, Vector2D playerPos, double whereToLook ) {
