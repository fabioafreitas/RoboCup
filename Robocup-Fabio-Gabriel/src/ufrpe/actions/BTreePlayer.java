...
public class BTreePlayer extends Thread {
	...
	public void run() {
		...
		commander.doMoveBlocking(this.homePosition.getX(),this.homePosition.getY());
	...
	void acaoGoleiro(Vector2D posicaoInicial) {

	}

	void acaoLateral(Vector2D posicaoInicial) {

	}

	void acaoZagueiro(Vector2D posicaoInicial) {

	}

	void acaoAtacante(Vector2D posicaoInicial) {

	}

	void acaoMeia(Vector2D posicaoInicial) {
